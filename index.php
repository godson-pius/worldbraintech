...
<section class="bg-center bg-no-repeat py-5 mt-lg-5"
    ...
    <div class="row no-gutters pt-lg-5 mt-lg-5">
        <!-- <div class="col-xl-7 col-lg-8"><img class="d-block" src="img/homepages/digital-agency/hero-img.jpg"
                alt="Hero Image"></div> -->
                <div class="col-xl-7 col-lg-8 rounded"><img class="d-block" src="img/frontend.jpg"
                alt="Hero Image"></div>
        <div class="col-lg-4 pt-xl-5">
            ...
            <div class="px-3 px-lg-0 text-center text-lg-left">
                <h1 class="pt-md-5 pb-md-4 pt-3 pb-3 pt-md-0 pb-md-5">Join the frontEnd Class </h1><a
                    class="scroll-to btn btn-style-4 btn-gradient btn-icon-right btn-lg" href="./register">Register<i
                        class="fe-icon-arrow-down"></i></a>
            </div>
