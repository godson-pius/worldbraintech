...
$.AdminsQuare.leftSideBar = {
    ...
    checkStatuForResize: function(firstTime) {
        ...
        if (width < 1170) {
            ...
            $(".sidebar").removeClass("h_menu");
            $openCloseBar.fadeIn();

        } else {
            $body.removeClass('ls-closed');
            $(".sidebar").addClass("h_menu");
...
/* Right chat bar - Function */
$.AdminsQuare.rightchat = {
    activate: function() {
        var _this = this;
        var $sidebar = $('#rightchat');
        var $overlay = $('.overlay');
        ...
        $(window).on('click',function(e) {
            ...
            if (!$target.hasClass('js-right-chat') && _this.isOpen() && $target.parents('#rightchat').length === 0) {
                if (!$target.hasClass('bars')) $overlay.fadeOut();
                $sidebar.removeClass('open');
            }
        });
