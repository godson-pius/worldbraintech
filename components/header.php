...
<!--                <a class="btn btn-primary btn-sm btn-block" href="account-login.html"><i class="fe-icon-user"></i>&nbsp;Login</a>-->
        ...
        <div class="offcanvas-scrollable-area border-top" style="height:calc(100% - 235px); top: 144px;">
            ...
            <div class="accordion mobile-menu" id="accordion-menu">
                <!-- Home-->
                <div class="card">
                    <div class="card-header"><a class="mobile-menu-link <?php if ($title == "World Brain Technology") : echo "active"; endif; ?>" href="index">Home</a></div>
                </div>

                <!-- About-->
                <div class="card">
                    <div class="card-header"><a class="mobile-menu-link <?php if ($title == "About | World Brain Technology") : echo "active"; endif; ?>" href="about">About</a></div>
                </div>

                <!-- Our Services-->
                <div class="card">
                    <div class="card-header"><a class="mobile-menu-link <?php if ($title == "Services | World Brain Technology") : echo "active"; endif; ?>" href="services">Services</a></div>
                </div>

                <!-- Our Works-->
                <div class="card">
                    <div class="card-header"><a class="mobile-menu-link <?php if ($title == "Portfolio | World Brain Technology") : echo "active"; endif; ?>" href="portfolio">Portfolio</a></div>
                </div>

                <!-- User Contact -->
                <div class="card">
                    <div class="card-header"><a class="mobile-menu-link <?php if ($title == "Contact | World Brain Technology") : echo "active"; endif; ?>" href="contact-us">Contact Us</a></div>
                </div>
            ...
            <div class="d-table-cell align-middle w-100 pl-md-3">
                <div class="navbar justify-content-end justify-content-lg-between">
                    ...
                    <ul class="navbar-nav d-none d-lg-block">
                        ...
                        <!-- User Contact-->
                        <li class="nav-item <?php if ($title == "Contact | World Brain Technology") : echo "active"; endif; ?>"><a class="nav-link" href="contact-us">Contact Us</a></li>
                    </ul>
                    <div>
