<footer class="d-lg-flex align-items-center bg-dark">
    ...
    <div class="w-100 py-5 px-4" style="background-color: #30363d;">
        <div class="widget widget-gallery mb-0 mx-auto" style="max-width: 250px;">
            ...
            <div class="pt-1"><a class="btn btn-gradient btn-block" href="#">&nbsp;View our Projects</a></div>
        </div>
    </div>
    <div class="w-100 py-5 px-4">
        <div class="mx-auto" style="max-width: 340px;">
            <h6 class="text-sm font-weight-medium text-white text-uppercase text-center">Subscribe to Newsletter</h6>
            <p class="text-sm text-white opacity-60 text-center pb-1">To receive latest works and upcoming projects</p>
            <form action="#" method="post" target="_blank" novalidate>
                <div class="input-group">
                    <input class="form-control form-control-light-skin" type="email" name="EMAIL" placeholder="Email email address">
...
<script src="//code.tidio.co/eu2ybls7qegp8wcfbvlglor50i9ozpct.js" async></script>
</body>
